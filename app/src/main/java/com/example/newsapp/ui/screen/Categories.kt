...
//bottomMenuのCategoriesボタンをクリックする際の遷移画面
@Composable
...
fun ArticleContentPreview(){
    ArticleContent(articles = listOf(TopNewsArticle(
        author = "Namita Singh",
        title = "Cleo Smith news - live : kidnap suspect in hospital again as",
        description = "Cleo Smith news - live : kidnap suspect in hospital again as",
